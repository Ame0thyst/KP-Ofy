...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_article'])) {
    ...
    if ($status === 'Published') {
        // Tambah kolom published_at di database saat artikel dipublish
        $conn->query("UPDATE articles SET published_at = '$now' WHERE id = $article_id");

        // Tambah jumlah artikel di tabel editors dan authors
